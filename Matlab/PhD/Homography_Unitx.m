...
ScaleSource = inv([0,0,1;from_y00,from_y01,from_y10;1,1,1])*[1;from_y11;1];
ScaleImage = inv([x00,x01,x10;y00,y01,y10;1,1,1])*[x11;y11;1];

%repmat(ScaleImage',3,1)

A = [0,0,1;from_y00,from_y01,from_y10;1,1,1].*repmat(ScaleSource',3,1);
